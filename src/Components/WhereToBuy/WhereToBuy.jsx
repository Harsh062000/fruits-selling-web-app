                     ...
                     <div className="container my-36">
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 place-items-center">
                                   ...
                                   <div className="space-y-8">
                                          <h1 data-aos="fade-up" data-aos-delay="300" className="text-4xl font-bold text-dark font-serif">Where to buy our products?</h1>
                                   ...
                                   <div data-aos="fade" className='col-span-2'>
                                          <img src={WorldMap} className='w-full sm:w-[500px] mx-auto' />
                                   </div>
                            </div>
                     </div>
              </>
