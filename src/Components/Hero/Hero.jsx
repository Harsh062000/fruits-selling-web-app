...
import OrangImg from '../../assets/orangebg.png';
       ...
       return (
              <main className="md:px-12 md:py-6 bg-primaryDark">
                     <section className="relative min-h-[650px] bg-gradient-to-r from-primary to-secondary w-full md:rounded-xl shadow-md">
                            <div className="container">
                                   ...
                                   >
                                          ...
                                          <div className="text-white mt-[100px] md:mt-0 p-4 space-y-4">
                                                 ...
                                                 <p data-aos="fade-up" data-aos-delay="500" className="text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, quia! Lorem ipsum dolor sit amet.</p>
                                          ...
                                          <div data-aos="zoom-in">
                                                 <img
                                                        src={OrangImg}
                                                        alt="Not Found"
                                                        className='reletive z-10 w-[400px] img-shadow'
                                                 />
                                          </div>
                            ...
                            <h1 data-aos="fade" data-aos-delay="6000" data-aos-duration="1800" className='large-text'>Orange</h1>
